...
- Location: tests\login.orangehrm.spec.ts:180:7
...
Call log:
  - waiting for getByRole('banner').getByRole('img', { name: /user profile/i })
...
- generic [ref=f1e3]:
        ...
        - list [ref=f1e123]:
          - listitem [ref=f1e124]:
            - generic [ref=f1e125] [cursor=pointer]:
              ...
              - paragraph [ref=f1e127]: Admin Admin
              - generic [ref=f1e128]: 
  ...
  - generic [ref=f1e135]:
    - generic [ref=f1e137]:
        ...
        - generic [ref=f1e146]:
          ...
          - generic [ref=f1e158]:
            - generic [ref=f1e159]:
              ...
              - paragraph [ref=f1e161]: Aug 31 - Sep 06
            - generic [ref=f1e162]:
              - generic [ref=f1e163]: 
      ...
      - generic [ref=f1e250]:
        ...
        - generic [ref=f1e258]:
          - generic [ref=f1e259] [cursor=pointer]:
            ...
            - generic [ref=f1e262]:
              - paragraph [ref=f1e263]: Admin Admin
      ...
      - generic [ref=f1e268]:
        - generic [ref=f1e269]:
          - paragraph [ref=f1e274]: Employees on Leave Today
          - generic [ref=f1e275] [cursor=pointer]: 
        - separator [ref=f1e276]
        - generic [ref=f1e278]:
          - img "No Content" [ref=f1e279]
          - paragraph [ref=f1e280]: No Employees are on Leave Today
      - generic [ref=f1e282]:
        - generic [ref=f1e284]:
          - generic [ref=f1e285]: 
          - paragraph [ref=f1e286]: Employee Distribution by Sub Unit
        - separator [ref=f1e287]
        - list [ref=f1e292]:
          - listitem [ref=f1e293] [cursor=pointer]:
            - generic "Human Resources" [ref=f1e295]
    ...
    - generic [ref=f1e317]:
      - paragraph [ref=f1e318]: OrangeHRM OS 5.9
      - paragraph [ref=f1e319]:
        - text: © 2005 - 2026
        - link "OrangeHRM, Inc" [ref=f1e320] [cursor=pointer]:
...
```ts
  ...
  5  | 
  6  |   readonly dashboardHeading: Locator;
  7  |   readonly quickLaunchCard: Locator;
  8  | 
  9  |   constructor(page: Page) {
  10 |     super(page);
  11 | 
  12 |     this.dashboardHeading = page.getByRole('heading', { name: 'Dashboard' });
  13 | 
  14 |     // Correct parent card
  15 |     this.quickLaunchCard = page.locator('div.oxd-grid-item', {
  16 |       has: page.getByText('Quick Launch')
  17 |     });
  18 |   }
  19 | 
  20 |   async verifyDashboardLoaded() {
  21 |     await expect(this.page).toHaveURL(/dashboard/);
  22 |     await expect(this.dashboardHeading).toBeVisible();
  23 |   }
  24 | 
  25 |   async clickAssignLeave() {
  26 |     await this.page.getByRole('button', { name: 'Assign Leave' }).click();
  27 |   }
  28 | 
  29 |   /**
  30 |    * Opens the user profile dropdown and clicks Logout.
  31 |    * Waits for navigation back to the login page (URL: /) before resolving.
  32 |    */
  33 |   async logout(): Promise<void> {
> 34 |     await this.page.getByRole('banner').getByRole('img', { name: /user profile/i }).click();
     |                                                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  35 |     await this.page.getByRole('menuitem', { name: /logout/i }).click();
