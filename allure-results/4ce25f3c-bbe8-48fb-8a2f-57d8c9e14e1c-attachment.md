...
- Name: login.orangehrm.spec.ts >> Invalid Password >> username field retains value and password field is cleared after wrong password
- Location: tests\login.orangehrm.spec.ts:94:7
...
Locator:  getByRole('textbox', { name: /username/i })
Expected: "Admin"
Received: ""
Timeout:  5000ms
