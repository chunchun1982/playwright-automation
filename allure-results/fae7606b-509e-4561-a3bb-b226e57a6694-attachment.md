...
- Name: login.orangehrm.spec.ts >> Invalid Username >> username field retains value and password field is empty after failed login
- Location: tests\login.orangehrm.spec.ts:61:7
