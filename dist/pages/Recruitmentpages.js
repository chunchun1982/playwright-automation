...
exports.RecruitmentPage = void 0;
...
class RecruitmentPage {
    ...
    async verifyCandidateAdded() {
        await (0, test_1.expect)(this.successToast).toBeVisible();
    }
    async verifyContactNumberEmpty() {
        await (0, test_1.expect)(this.contactNumberInput).toHaveValue('');
    }
    ...
    async selectAutoSuggestion(input, value) {
    ...
    async verifyCandidatePresent(name) {
...
exports.RecruitmentPage = RecruitmentPage;
//# sourceMappingURL=Recruitmentpages.js.map